...
# Get drive letter
letter = input("\nEnter the drive letter assigned to your Pico (e.g., 'D'): ").strip().upper()
...
input("\nPico has been formatted and CircuitPython is installed. Please disconnect and reconnect your Pico, then press Enter to continue...")

letter = input("\nEnter the new drive letter assigned to your Pico (e.g., 'E'): ").strip().upper()
